/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a13976511cfa516731d37a66c2a0c5a4)
// Runtime types generated with workerd@1.20250803.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_HUBSPOT_INTAKE_FORM_ID: string;
		NEXT_PUBLIC_HUBSPOT_FORM_SUBMIT_ENDPOINT: string;
